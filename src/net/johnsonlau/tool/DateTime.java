...
public class DateTime {
	...
	public static final String getUtcSecondTimestampString(){
		return String.valueOf(getUtcSecondTimestamp());
	}
	...
	public static final String getUtcMilliSecondTimestampString(){
		return String.valueOf(getUtcMilliSecondTimestamp());
	}
}
